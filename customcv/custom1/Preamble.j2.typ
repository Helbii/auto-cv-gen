...
#let cv-section-top-space = 0.14cm
#let cv-title-bottom-space = 0.10cm
#let cv-section-bottom-space = 0.06cm

#let cv-entry-bottom-space = 0.10cm
#let cv-entry-inner-space = 0.06cm
#let cv-par-leading = 0.80em

// === Rythme vertical unique pour TOUT le CV ===
// leading (interligne d'un wrap) == block spacing (gap entre blocs) => rythme uniforme
#let cv-rhythm = 0.55em
#let cv-body-size = 8.5pt
